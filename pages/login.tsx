...
const Login = () => {
    ...
    return (
        <>
            ...
            <div className="w-screen h-screen relative bg-slate-200">
                <div className="h-full w-full p-5 lg:p-12 flex items-center justify-center relative overflow-hidden">
                    <div className="h-full w-full p-12 md:rounded-lg shadow bg-sky-600/40 backdrop-blur-3xl">
                        <div className="container relative">
                            ...
                            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                                    ...
                                    <div className="md:me-6">
                                        ...
                                        <div>
                                            <button
                                                ...
                                                className="px-4 py-3 rounded bg-sky-500 text-white hover:bg-sky-600 transition-all duration-500">
                                                Mulai Sekarang
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div className="md:col-span-4 aos-init flex items-center justify-center flex-col gap-5 h-[calc(100vh-200px)]">
                                    ...
                                    <form
                                        ...
                                        <div className="w-full">
                                            <button
                                                disabled={isLoading}
                                                type='submit'
                                                className="w-full bg-blue-900 text-white rounded px-3 py-2 focus:outline-none transition-all duration-300 hover:bg-blue-600">
                                                Masuk
                                            </button>
                                        </div>
                                        <hr />
                                        <div className="flex items-center justify-center">
                                            <button
                                                ...
                                                className="flex items-center justify-center gap-2 bg-white hover:bg-slate-100 hover:text-blue-900 px-3 py-2 rounded-xl">
                                                <img src="/assets/images/google.png"
                                                    className="h-[20px] mx-auto" alt="Logo Ogan Ilir" />
